...
export const ENV_MAPPING = {
  ...
  // 搜索索引配置
  REPO_VIEWER_SEARCH_INDEX_ENABLED: 'VITE_REPO_VIEWER_SEARCH_INDEX_ENABLED',
  REPO_VIEWER_SEARCH_INDEX_BRANCH: 'VITE_REPO_VIEWER_SEARCH_INDEX_BRANCH',
  REPO_VIEWER_SEARCH_DEFAULT_BRANCH: 'VITE_REPO_VIEWER_SEARCH_DEFAULT_BRANCH',
  REPO_VIEWER_SEARCH_MANIFEST_PATH: 'VITE_REPO_VIEWER_SEARCH_MANIFEST_PATH',
  REPO_VIEWER_SEARCH_REFRESH_INTERVAL_MS: 'VITE_REPO_VIEWER_SEARCH_REFRESH_INTERVAL_MS',
